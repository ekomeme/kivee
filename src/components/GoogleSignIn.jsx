    ...
    <div className="flex h-screen w-screen font-sans">
      ...
      <div className="w-1/2 bg-white flex flex-col justify-center items-center p-12 relative">
        ...
        <div className="w-full max-w-[360px]">
          ...
          <button 
            onClick={onClick} 
            className="w-full bg-primary hover:bg-primary-hover text-white font-medium py-3 px-4 rounded-sm flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary mt-12 text-base"
          >
