  ...
  return (
    <div className="flex h-screen w-screen font-sans">
      ...
      <div className="w-1/2 bg-section flex flex-col justify-center items-center p-12 relative">
        ...
        <div className="w-full max-w-[376px] space-y-12">
          <div className="space-y-1">
            <h1 className="auth-heading-primary">Welcome to Kivee</h1>
            <h2 className="auth-heading-secondary">Your academy management tool</h2>
          </div>
          <button
            onClick={onClick}
            disabled={loading}
            className="btn-primary w-full text-base h-12 px-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
          >
